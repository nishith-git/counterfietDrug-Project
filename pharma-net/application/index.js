...
// ________________________________________________________API route to invoke "initializeAllIdentititiesDoneAtOnce"
app.get('/initializeAllIdentititiesDoneAtOnce', (req, res) => {
	addToWallet.initializeAllIdentititiesDoneAtOnce()
		.then(() => {
			const result = {
				status: 'success',
